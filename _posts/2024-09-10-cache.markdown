...
out of 23 participants (18 in round 2).
...
* Manual growth with FEgrow is useful for idea generation, but automating searches are needed on a tight deadline.
...
Indeed, we have subsequently made a number of improvements to FEgrow to enable active-learning driven
